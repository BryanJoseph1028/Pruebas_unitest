...
class TestPageLoadTime(unittest.TestCase):
    ...
    def test_home_page_load_time(self):
        home_url = "https://elevenstore.netlify.app/"  # Reemplaza con la URL de tu página principal
    ...
    def test_product_page_load_time(self):
        product_url = "https://elevenstore.netlify.app/"  # Reemplaza con la URL de un producto en tu tienda
